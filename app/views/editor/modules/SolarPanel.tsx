    ...
    return (
      <>
        ...
        <TransformedPath
                ...
                points={solarPanel.getCoordinates(oneZentimeterHorizontal, oneZentimeterVertical)}
                      />
          ...
          {displayGrid && <TransformedPath
                            ...
                            allScreen={allScreen}
                            roofPoints={roofPoints}
                            points={solarPanel.getWrapperCoordinates(oneZentimeterHorizontal, oneZentimeterVertical)}
                    />  }

    
              
        {debugView && <Path path={pointsToSvg(solarPanel.getCoordinates(oneZentimeterHorizontal, oneZentimeterVertical))} 
                            opacity={1} 
                            style="stroke" 
                            strokeJoin="round" 
                            color={'green'} 
