...
function Settings({}: StackScreenProps<any>): React.JSX.Element {
  ...
  return (
    <View style={GlobalStyles.pageWrapper}>
      <AppBar title={t('settings:title')}></AppBar>

      <View style={GlobalStyles.siteContainer}>
        <List.Section style={{width: '100%'}}>
          <Text
            variant="labelLarge"
            style={{color: ThemeDark.colors.primary, width: '100%'}}>
          ...
          {languages.map((currentLang, i) => {
            ...
            return (
              <List.Item
                ...
                left={() => (
                  <List.Icon
                    color={selectedLanguage ? ThemeDark.colors.primary : ''}
                    icon="book"
                  />
                )}
              />
