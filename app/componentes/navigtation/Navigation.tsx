    ...
    <Tab.Navigator
      ...
      tabBar={({navigation, state, descriptors, insets}) => (
        <BottomNavigation.Bar
          ...
          getLabelText={({route}) => {
            return routesDefinition.filter(r => route.key.startsWith(r.key))[0]
              .title;
          }}
        />
      )}>
        ...
        <Tab.Screen
          ...
          options={{
            ...
            tabBarIcon: ({color, size}) => {
              return (
                <Icon source={route.focusedIcon} size={size} color={color} />
              );
            },
          }}
        />
